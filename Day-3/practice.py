...
#1) int – Real-life integer examples
...
# 2) float – Real-life decimal examples
...
#4) bool – Real-life boolean examples
...
#5) list – Real-life ordered collection examples
...
#6) tuple – Real-life fixed ordered collection examples
...
#7) set – Real-life unique collection examples
# Stores unique data
...
#8) dict – Real-life key-value examples
...
#9) NoneType – Real-life placeholder examples
